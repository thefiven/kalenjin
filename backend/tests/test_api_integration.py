...
from kalenjin.api import _get_db_session, app, get_activity_repository, get_llm_client
...
def test_create_objectif_shares_one_real_session_across_its_two_repositories(
    ...
    """Only `_get_db_session` is overridden here — `get_objectif_repository` and
